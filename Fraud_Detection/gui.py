...
def main():
    ...
    if str(url).find("http") != -1:
        ...
        if pred[0] == 1:
            ...
            print(colorama.Fore.GREEN + "This news is REAL!")


        # Elif df['text'][0] contains the word "Disclaimer":
        elif df['text'][0].find("Disclaimer") != -1:
            # print("This news is fake!")
            print(colorama.Fore.RED + "This news is REAL!")
        ...
        if df['text'][0].find("Disclaimer") != -1:
            # print("This news is fake!")
            print(colorama.Fore.RED + "This news is FAKE!")


        else:
            print(colorama.Fore.RED + "This news is FAKE!")

    verify_button = tk.Button(window, text="Verify", command=main)
    verify_button.pack()
